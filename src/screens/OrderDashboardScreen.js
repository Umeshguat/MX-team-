...
export default function OrderDashboardScreen({ user, onGoBack, onLogout, onGoToProfile, onGoToInventory, onGoToOrderList, onGoToShopList, onGoToDeliveryList, onGoToReturnRequest }) {
        ...
        <View style={{ marginBottom: 10 }}>
          ...
          {onGoToShopList ? (
            <TouchableOpacity
              ...
              onPress={onGoToShopList}
              activeOpacity={0.7}
            >
              <View style={{ width: 46, height: 46, borderRadius: 14, justifyContent: 'center', alignItems: 'center', marginRight: 14, backgroundColor: theme.info + '18' }}>
                <Text style={{ fontSize: 22 }}>🏪</Text>
              </View>
              <View style={{ flex: 1 }}>
