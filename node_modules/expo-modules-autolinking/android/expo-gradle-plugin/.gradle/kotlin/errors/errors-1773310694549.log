...
error message: The daemon has terminated unexpectedly on startup attempt #3 with exit code: 1. The daemon process output:
    1. OpenJDK 64-Bit Server VM warning: INFO: os::commit_memory(0x0000000080000000, 197132288, 0) failed; error='The paging file is too small for this operation to complete' (DOS error/errno=1455)
    2. #
    3. # There is insufficient memory for the Java Runtime Environment to continue.
    4. # Native memory allocation (mmap) failed to map 197132288 bytes. Error detail: G1 virtual space
    5. # An error report file with more information is saved as:
    6. # C:\Users\LENOVO\AppData\Local\kotlin\daemon\hs_err_pid11756.log
The daemon didn't produce the message "Kotlin compile daemon is ready" during startup.
